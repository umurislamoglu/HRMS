...
public class DPAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DPADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DPAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DPADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DPADateTimeConverter dateTimeConverter = new DPAStandardDateTimeConverter();

    public DPAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DPAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DPAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DPAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DPAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DPAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
