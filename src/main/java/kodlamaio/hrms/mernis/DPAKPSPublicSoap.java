...
public class DPAKPSPublicSoap
{
    ...
    public DPAKPSPublicSoap(){}

    public DPAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DPAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DPAExtendedSoapSerializationEnvelope envelope= new DPAExtendedSoapSerializationEnvelope(DPAExtendedSoapSerializationEnvelope.VER11);
