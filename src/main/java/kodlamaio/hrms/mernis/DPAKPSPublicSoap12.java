...
public class DPAKPSPublicSoap12
{
    interface DPAIWcfMethod
    {
        DPAExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(DPAExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public DPAKPSPublicSoap12(){}

    public DPAKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public DPAKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected DPAExtendedSoapSerializationEnvelope createEnvelope()
    {
        DPAExtendedSoapSerializationEnvelope envelope= new DPAExtendedSoapSerializationEnvelope(DPAExtendedSoapSerializationEnvelope.VER12);
        envelope.setEnableLogging( enableLogging);
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,DPAExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,DPAExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new DPAIWcfMethod()
        {
            @Override
            public DPAExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                DPAExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(DPAExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(DPAIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        DPAExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,DPAExtendedSoapSerializationEnvelope envelope)
    {
